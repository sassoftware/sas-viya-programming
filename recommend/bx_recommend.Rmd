...
#s <- CAS(hostname, 5570)
Sys.setenv(CAS_CLIENT_SSL_CA_LIST='/u/mimcki/d5-17w47.uda.sashq-r.openstack.sas.com.crt')                                                                    
#s <- CAS("d5-17w47.uda.sashq-r.openstack.sas.com", 5570) 
s <- CAS("rdcgrdc", 12636)
...
files_dir <- "/u/mimcki/lasr27/clean/"
